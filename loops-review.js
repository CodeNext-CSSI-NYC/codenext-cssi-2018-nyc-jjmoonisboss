...
// let newPass = readline.question("Guess the password: ");
//
// let passWord = "woahTechnology";
// let pswdCounter = 0;
// while (newPass != passWord) {
//   console.log(" nope try again");
//   newPass = readline.question("Guess the password: ");
//   pswdCounter++;
// }
// if (newPass == "woah") {
//   console.log("You are almost there a little bit further-");
// }
