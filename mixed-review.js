...
//   let quest = parseInt(readline.question("Type in a number , any number: "));
//   if (quest % 2 == 0) {
//     console.log(quest + " is even");
//   } else {
//     console.log(quest + " is odd");
//   }
//   console.log(evenOdd());
// }
// evenOdd();
...
//   let userNum = parseInt(readline.question("Type in a number,please: "));
//   let total = 0;
...
function fibonacci(num) {
  ...
  for (var i = 0; i < num; i++) {
    ...
    let secondToLastNum = arr[arr.length - 2];
    arr.push(lastNum + secondToLastNum);
  }
  return arr;
}
